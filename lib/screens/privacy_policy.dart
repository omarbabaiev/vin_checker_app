...
class _PrivacyPolicyState extends State<PrivacyPolicy> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Privacy policy", style: GoogleFonts.aldrich(fontWeight: FontWeight.bold, fontSize: 35, color: Colors.white),),
          ...
          child: SafeArea(
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Text(_text, textAlign: TextAlign.justify, style: TextStyle(color: Colors.white, fontSize: 20),),
              ),
            ),
          )
          ),
